                ...
                <div className="card" style={{ borderRadius: '20px', overflow: 'hidden', background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
                    ...
                    <div className="table-responsive">
                        <table className="data-table w-full">
                            <thead>
                                <tr>
                                    <th className="text-left" style={{ fontSize: '15px' }}>Rank</th>
                                    <th className="text-left" style={{ fontSize: '15px' }}>Service Name</th>
                                    <th className="text-center" style={{ fontSize: '15px' }}>Usage</th>
                                    <th className="text-right" style={{ fontSize: '15px' }}>Revenue</th>
                                    <th className="text-right" style={{ paddingRight: '28px', fontSize: '15px' }}>Contribution</th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td style={{ padding: '18px 24px' }}>
                                                <div style={{ fontWeight: 700, color: 'var(--text-main)', fontSize: '14px' }}>{service.service_name}</div>
                                            </td>
