            ...
            <div className="page-header mb-8">
                <div>
                    <nav className="breadcrumbs text-muted mb-2">
                        ...
                        <span className="breadcrumb-separator mx-2 text-slate-300">/</span>
                        <Link href={`/dashboard/customers/${params.id}`} className="breadcrumb-item text-slate-400 hover:text-primary transition-colors">{data.customer.customer_no || params.id}</Link>
                        <span className="breadcrumb-separator mx-2 text-slate-300">/</span>
